...
| Cell | Class | rdlt median | vs baseline | Target | rows/s | MB/s | peak CPU | peak RSS |
|---|---|---|---|---|---|---|---|---|
| pg-wide-duckdb-1m | gated | 1.24 s | **8.4×** (dlt-pyarrow: 10.44 s) | ≥ 6× | 803387 | 153.0 | 640% | 447 MB |
| pg-wide-pg-1m | gated | 2.12 s | **8.2×** (dlt-pyarrow: 17.40 s) | ≥ 6× | 471606 | 89.8 | 207% | 145 MB |
