...
|---|---|---|---|---|---|---|---|
| pg-to-pg-1m | 1.96 s (±13%) | **5.3×** (dlt: 10.41 s); 8.8× (dlt-pyarrow: 17.17 s); 23.2× (airbyte: 45.41 s) | ≥ 4× | PASS | 510579 | 97.2 | 142 MB |
| pg-to-s3parquet-1m | 1.60 s (±3%) | **1.0×** (dlt: 1.68 s); 6.7× (dlt-pyarrow: 10.76 s); 28.3× (airbyte: 45.39 s) | — | — | 623983 | 118.8 | 153 MB |
| s3jsonl-to-pg-200k | 1.13 s (±3%) | **40.0×** (airbyte: 45.37 s); 55.6× (dlt: 63.06 s) | ≥ 40× | PASS | 528753 | 126.0 | 202 MB |
| s3jsonl-to-s3parquet-200k | 969.0 ms (±3%) | **46.8×** (airbyte: 45.37 s); 60.1× (dlt: 58.28 s) | ≥ 45× | PASS | 619214 | 147.6 | 212 MB |
| pg-to-pg-dedup-1m | 5.00 s (±1%) | **2.5×** (dlt: 12.48 s); 4.0× (dlt-pyarrow: 20.16 s); 9.1× (airbyte: 45.39 s) | ≥ 2× | PASS | 200166 | 38.0 | 143 MB |
...
|---|---|---|---|---|
| pg-to-pg-1m | airbyte | 45.41 s | 45.43 s | -0.0% |
| pg-to-pg-1m | dlt | 10.41 s | 10.20 s | +2.1% |
| pg-to-pg-1m | dlt-pyarrow | 17.17 s | 17.46 s | -1.7% |
| pg-to-pg-1m | rdlt | 1.96 s | 2.09 s | -6.3% |
| pg-to-pg-dedup-1m | airbyte | 45.39 s | 60.47 s | -24.9% |
| pg-to-pg-dedup-1m | dlt | 12.48 s | 12.74 s | -2.1% |
| pg-to-pg-dedup-1m | dlt-pyarrow | 20.16 s | 20.53 s | -1.8% |
| pg-to-pg-dedup-1m | rdlt | 5.00 s | 5.03 s | -0.6% |
| pg-to-s3parquet-1m | airbyte | 45.39 s | 45.38 s | +0.0% |
| pg-to-s3parquet-1m | dlt | 1.68 s | 1.67 s | +0.6% |
| pg-to-s3parquet-1m | dlt-pyarrow | 10.76 s | 10.81 s | -0.5% |
| pg-to-s3parquet-1m | rdlt | 1.60 s | 1.59 s | +1.0% |
| s3jsonl-to-pg-200k | airbyte | 45.37 s | 45.38 s | -0.0% |
| s3jsonl-to-pg-200k | dlt | 63.06 s | 63.20 s | -0.2% |
| s3jsonl-to-pg-200k | rdlt | 1.13 s | 1.19 s | -5.0% |
| s3jsonl-to-s3parquet-200k | airbyte | 45.37 s | 45.37 s | -0.0% |
| s3jsonl-to-s3parquet-200k | dlt | 58.28 s | 58.45 s | -0.3% |
| s3jsonl-to-s3parquet-200k | rdlt | 969.0 ms | 974.2 ms | -0.5% |
| selftest-protocol | rdlt | 21.6 ms | 21.1 ms | +2.5% |
