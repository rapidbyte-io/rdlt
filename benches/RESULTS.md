...
| oracle-to-pg-200k | 837.3 ms (±4%) | **4.0×** (dlt: 3.35 s); airbyte: MISSING (prerequisite failed for `airbyte`: abctl cluster unreachable (kubectl get ns airbyte-abctl)) | — | — | 238855 | 46.6 | 60 MB |
...
|---|---|---|---|---|
| oracle-to-pg-200k | dlt | 3.35 s | — | — |
| oracle-to-pg-200k | rdlt | 837.3 ms | — | — |
