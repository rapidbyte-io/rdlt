...
|---|---|---|---|---|---|---|---|
| pg-to-pg-1m | 2.05 s (±18%) | **5.0×** (dlt: 10.21 s); 8.5× (dlt-pyarrow: 17.42 s); 22.2× (airbyte: 45.37 s) | ≥ 4× | PASS | 488852 | 93.1 | 148 MB |
| pg-to-s3parquet-1m | 1.61 s (±3%) | **1.0×** (dlt: 1.67 s); 6.8× (dlt-pyarrow: 10.93 s); 28.2× (airbyte: 45.39 s) | — | — | 620498 | 118.2 | 152 MB |
| s3jsonl-to-pg-200k | 1.13 s (±24%) | **40.2×** (airbyte: 45.40 s); 56.8× (dlt: 64.08 s) | ≥ 40× | PASS | 531496 | 126.7 | 192 MB |
| s3jsonl-to-s3parquet-200k | 956.1 ms (±4%) | **47.5×** (airbyte: 45.38 s); 61.9× (dlt: 59.15 s) | ≥ 45× | PASS | 627566 | 149.6 | 214 MB |
| pg-to-pg-dedup-1m | 14.81 s (±8%) | **0.8×** (dlt: 12.48 s); 1.4× (dlt-pyarrow: 20.38 s); 4.1× (airbyte: 60.43 s) | — | — | 202514 | 39.2 | 283 MB |
...
|---|---|---|---|---|
| pg-to-pg-1m | airbyte | 45.37 s | — | — |
| pg-to-pg-1m | dlt | 10.21 s | 10.20 s | +0.1% |
| pg-to-pg-1m | dlt-pyarrow | 17.42 s | 17.33 s | +0.5% |
| pg-to-pg-1m | rdlt | 2.05 s | 2.22 s | -7.8% |
| pg-to-pg-dedup-1m | airbyte | 60.43 s | — | — |
| pg-to-pg-dedup-1m | dlt | 12.48 s | 12.55 s | -0.6% |
| pg-to-pg-dedup-1m | dlt-pyarrow | 20.38 s | 20.33 s | +0.3% |
| pg-to-pg-dedup-1m | rdlt | 14.81 s | 14.75 s | +0.4% |
| pg-to-s3parquet-1m | airbyte | 45.39 s | — | — |
| pg-to-s3parquet-1m | dlt | 1.67 s | 1.66 s | +0.9% |
| pg-to-s3parquet-1m | dlt-pyarrow | 10.93 s | 10.79 s | +1.3% |
| pg-to-s3parquet-1m | rdlt | 1.61 s | 1.60 s | +1.0% |
| s3jsonl-to-pg-200k | airbyte | 45.40 s | — | — |
| s3jsonl-to-pg-200k | dlt | 64.08 s | 63.56 s | +0.8% |
| s3jsonl-to-pg-200k | rdlt | 1.13 s | 1.16 s | -2.5% |
| s3jsonl-to-s3parquet-200k | airbyte | 45.38 s | — | — |
| s3jsonl-to-s3parquet-200k | dlt | 59.15 s | 59.10 s | +0.1% |
| s3jsonl-to-s3parquet-200k | rdlt | 956.1 ms | 966.7 ms | -1.1% |
| selftest-protocol | rdlt | 21.9 ms | — | — |
