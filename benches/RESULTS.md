...
|---|---|---|---|---|---|---|---|
| pg-to-pg-1m | 778.8 ms (±3%) | **13.2×** (dlt: 10.26 s); 22.2× (dlt-pyarrow: 17.32 s); 77.6× (airbyte: 60.44 s) | ≥ 4× | PASS | 1283958 | 244.6 | 106 MB |
| pg-to-s3parquet-1m | 999.4 ms (±1%) | **1.7×** (dlt: 1.68 s); 10.9× (dlt-pyarrow: 10.86 s); 45.4× (airbyte: 45.37 s) | — | — | 1000642 | 190.6 | 113 MB |
| s3jsonl-to-pg-200k | 665.2 ms (±1%) | **68.2×** (airbyte: 45.38 s); 95.0× (dlt: 63.16 s) | ≥ 40× | PASS | 902015 | 215.0 | 172 MB |
| s3jsonl-to-s3parquet-200k | 914.1 ms (±20%) | **49.6×** (airbyte: 45.38 s); 63.6× (dlt: 58.11 s) | ≥ 45× | PASS | 656415 | 156.5 | 208 MB |
| pg-to-pg-dedup-1m | 4.82 s (±3%) | **2.6×** (dlt: 12.76 s); 4.3× (dlt-pyarrow: 20.57 s); 9.4× (airbyte: 45.38 s) | ≥ 2× | PASS | 207510 | 39.4 | 111 MB |
...
| pg-to-pg-1m | dlt | 10.26 s | 10.54 s | -2.6% |
| pg-to-pg-1m | dlt-pyarrow | 17.32 s | 17.30 s | +0.1% |
| pg-to-pg-1m | rdlt | 778.8 ms | 793.8 ms | -1.9% |
| pg-to-pg-dedup-1m | airbyte | 45.38 s | 45.39 s | -0.0% |
| pg-to-pg-dedup-1m | dlt | 12.76 s | 12.48 s | +2.2% |
| pg-to-pg-dedup-1m | dlt-pyarrow | 20.57 s | 20.16 s | +2.1% |
| pg-to-pg-dedup-1m | rdlt | 4.82 s | 5.00 s | -3.5% |
| pg-to-s3parquet-1m | airbyte | 45.37 s | 45.39 s | -0.0% |
| pg-to-s3parquet-1m | dlt | 1.68 s | 1.68 s | +0.3% |
| pg-to-s3parquet-1m | dlt-pyarrow | 10.86 s | 10.76 s | +0.9% |
| pg-to-s3parquet-1m | rdlt | 999.4 ms | 1.60 s | -37.6% |
| s3jsonl-to-pg-200k | airbyte | 45.38 s | 45.37 s | +0.0% |
| s3jsonl-to-pg-200k | dlt | 63.16 s | 63.06 s | +0.2% |
| s3jsonl-to-pg-200k | rdlt | 665.2 ms | 1.13 s | -41.4% |
| s3jsonl-to-s3parquet-200k | airbyte | 45.38 s | 45.37 s | +0.0% |
| s3jsonl-to-s3parquet-200k | dlt | 58.11 s | 58.28 s | -0.3% |
| s3jsonl-to-s3parquet-200k | rdlt | 914.1 ms | 969.0 ms | -5.7% |
| selftest-protocol | rdlt | 21.8 ms | 21.6 ms | +0.7% |
