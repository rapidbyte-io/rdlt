#!/usr/bin/env python3
"""Bootstrap the Polaris bench fixture (016): wait for the API, create the
...
rootless-podman host alias), grant the admin role. Stdlib-only; fixture
tooling — never product code.
