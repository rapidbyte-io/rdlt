//! The ONE control-and-invisible-codepoint inventory: everything
...
//! glyphs and are classic spoofing letters). It lives in this crate
//! because more than one side of a boundary must agree on it — both
//! sides of the connector wire and the CLI's display seats refuse and
//! escape by one table instead of each carrying its own approximation.
//! The table is hand-listed and sorted; extend it in order, with the
//! name of what each entry is.
