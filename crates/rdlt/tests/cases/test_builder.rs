...
"#;
    let doc: document::Document = document::parse(with_policy).expect("parses");
    ...
    let doc: document::Document = document::parse(&empty).expect("parses");
    ...
    let doc: document::Document = document::parse(&none).expect("parses");
