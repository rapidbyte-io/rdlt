            ...
            tables: [(
                ...
                TableOptions {
                    ...
                    scd2: refinements.scd2_retire.then(|| {
                        rdlt_connector_postgres_v2::destination::Scd2Options {
                            absent: rdlt_connector_postgres_v2::destination::AbsentPolicy::Retire,
                            ..rdlt_connector_postgres_v2::destination::Scd2Options::default()
                        }
                    }),
