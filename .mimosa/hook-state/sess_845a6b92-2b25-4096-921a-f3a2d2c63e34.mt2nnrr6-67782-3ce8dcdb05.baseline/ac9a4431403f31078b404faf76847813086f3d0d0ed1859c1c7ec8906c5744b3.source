...
|---|---|---|---|---|---|---|---|
| pg-to-pg-1m | 1.04 s (±5%) | **9.9×** (dlt: 10.34 s); 17.0× (dlt-pyarrow: 17.68 s) | ≥ 4× | PASS | 959158 | 163.0 | 255 MB |
| pg-to-s3parquet-1m | 966.0 ms (±2%) | **1.7×** (dlt: 1.68 s); 11.7× (dlt-pyarrow: 11.26 s) | — | — | 1035191 | 176.0 | 297 MB |
| s3jsonl-to-pg-200k | 817.0 ms (±8%) | **79.4×** (dlt: 64.90 s) | ≥ 40× | PASS | 734401 | 155.8 | 306 MB |
| s3jsonl-to-s3parquet-200k | 1.06 s (±17%) | **56.6×** (dlt: 60.21 s) | ≥ 45× | PASS | 564497 | 119.8 | 326 MB |
| pg-to-pg-dedup-1m | 4.82 s (±2%) | **2.6×** (dlt: 12.61 s); 4.3× (dlt-pyarrow: 20.82 s) | ≥ 2× | PASS | 207319 | 35.2 | 259 MB |
...
_Generated by `rdlt-bench report` from committed artifacts (recorded 2026-08-13, 2026-08-14; airbyte 2.1.1, dlt 1.29.0)._
...
| pg-to-pg-1m | dlt | 10.34 s | — | — |
| pg-to-pg-1m | dlt-pyarrow | 17.68 s | — | — |
| pg-to-pg-1m | rdlt | 1.04 s | — | — |
| pg-to-pg-dedup-1m | dlt | 12.61 s | — | — |
| pg-to-pg-dedup-1m | dlt-pyarrow | 20.82 s | — | — |
| pg-to-pg-dedup-1m | rdlt | 4.82 s | — | — |
| pg-to-s3parquet-1m | dlt | 1.68 s | — | — |
| pg-to-s3parquet-1m | dlt-pyarrow | 11.26 s | — | — |
| pg-to-s3parquet-1m | rdlt | 966.0 ms | — | — |
| s3jsonl-to-pg-200k | dlt | 64.90 s | — | — |
| s3jsonl-to-pg-200k | rdlt | 817.0 ms | — | — |
| s3jsonl-to-s3parquet-200k | dlt | 60.21 s | — | — |
| s3jsonl-to-s3parquet-200k | rdlt | 1.06 s | — | — |
