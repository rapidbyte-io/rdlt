...
- [X] T001 Scaffold the harness crate: add `crates/rdlt-bench` to
...
- [X] T002 Cell + bar loaders welded to their typed-error cells:
...
- [X] T003 Measurement protocol as code:
...
- [X] T004 [P] [US1] Fixture lifecycle in
  ...
  in US3).
- [X] T005 [US1] Subprocess runner + `list`/`run` commands in
...
- [X] T006 [P] [US2] Procfs sampler in
...
- [X] T008 [P] [US2] Artifact schema v1 in
...
- [X] T009 [US2] Competitor module in
...
- [X] T010 [US2] Gate in `crates/rdlt-bench/src/gate.rs` +
...
- [X] T011 [US2] Report in `crates/rdlt-bench/src/report.rs`: splice
